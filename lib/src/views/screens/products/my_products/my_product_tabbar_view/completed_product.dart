...
class CompletedProductTabBarView extends StatefulWidget {
  const CompletedProductTabBarView({Key? key}) : super(key: key);

  @override
  State<CompletedProductTabBarView> createState() => _CompletedProductTabBarViewState();
}

class _CompletedProductTabBarViewState extends State<CompletedProductTabBarView> {
  ...
  getdata()async{
    var a = await productController.productBookings(value: '2');
    if(a == true){
      loading.value = false;
      // loading.refresh();
    }else{
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
        ...
        children: [
          ...
          if(productController.myProducts.isEmpty)Center(child: Text('No Orders Completed Yet.'),),
        ],
      ),
    );
  }
